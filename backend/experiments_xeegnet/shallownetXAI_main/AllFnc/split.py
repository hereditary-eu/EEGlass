...
def create_nested_kfold_subject_split(
    ...
    if folds > subj:
        raise ValueError("Number of folds cannot be greater" + " than the number of subjects")
...
def merge_partition_lists_noshift(
    l1: list[list[int], list[int], list[int]], l2: list[list[int], list[int], list[int]]
) -> list[list[int], list[int], list[int]]:
    """
...
def merge_partition_lists(
    l1: list[list[int], list[int], list[int]], l2: list[list[int], list[int], list[int]], folds: int, folds_nested: int
) -> list[list[int], list[int], list[int]]:
    """
