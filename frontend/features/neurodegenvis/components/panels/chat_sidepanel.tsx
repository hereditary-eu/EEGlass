  ...
  return (
    <div className={`sidepanel ${showChat ? "expanded" : "collapsed"}`}>
      ...
      <div className="sidepanel-header">
        <h5>Chatbot</h5>
        <button type="button" className="neuro-close-button" aria-label="Close" onClick={onClose}>
          x
        </button>
      </div>
      ...
      <div className="sidepanel-body">
        ...
        <div className="chat-prompt-container">
          <div className="container-suggest-clear-button">
            <button type="button" className="neuro-button" onClick={clearChatHistory}>
              Clear History
            </button>

            <div className="chat-suggest-button">
              <button type="button" className="neuro-button" onClick={submitSuggest}>
                Suggest Features
              </button>
            </div>
          </div>
          ...
          <div className="chat-textInput-container">
            ...
            <button type="button" className="neuro-button" onClick={submitPrompt}>
              Submit
            </button>
          </div>
