...
import { clusterPatients } from "../../services/analysisService";
    ...
    <div>
      ...
      <div className="kmeans-container">
        ...
        <input
          ...
          max="20"
        />
        <button type="button" className="neuro-button" onClick={() => setPatientDataFunc(clusterPatients(patients_data, k))}>
          Run
        </button>
      </div>
